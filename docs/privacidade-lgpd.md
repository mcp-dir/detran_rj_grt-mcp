...
DETRAN RJ: GRT (Guia de Regularização de Taxas) segue a LGPD (Lei nº 13.709/2018).
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [detran_rj_grt@mcp.ai](mailto:detran_rj_grt@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
